...
%%%
%%% @end
%%% Created : 23 Jun 2013 by  <>
%%%-------------------------------------------------------------------
-module(erlmur_channel_feed).

-behaviour(gen_event).

%% API
-export([start_link/0, add_handler/0, join_feed/1, leave_feed/1, notify/1]).
...
leave_feed(HandlerId) ->
    gen_event:delete_handler(?SERVER, HandlerId, leave_feed).
