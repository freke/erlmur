...
-export([new/0, client_ping/2, times/2, packets/2, server_ping/2, server_ping/1, stats/1]).
...
server_ping({Good,Late,Lost},Stats) ->
	ServerPing = Stats#stats.server_ping,
	NewServerPing = ServerPing#ping_stats{good=Good,late=Late,lost=Lost},
