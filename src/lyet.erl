...
%%% under the License.
%%%
%%% The Original Code is ct_expand.erl
%%%
%%% The Initial Developer of the Original Code is Ericsson Telecom
%%% AB. Portions created by Ericsson are Copyright (C), 1998, Ericsson
%%% Telecom AB. All Rights Reserved.
%%%
%%% Contributor(s): Paul Mineiro
%%%
%%% ------------------------------------------------------------------
-module(lyet).

%% Most of this is "library" code extracted from ct_expand.erl
%% the custom stuff is in parse_transform/2
...
%%% Any expression wrapped inside a call to lyet:lyet(Var = Value, Expr) is
...
[] ->
erlang:error("illegal_form: lyet:lyet() requires at least one argument.");
L=[_|_]->
...
function({"local", let_, any},
LetToLambda,
function({?MODULE, lyet, any}, LetToLambda, Forms, Options),
Options).
